module github.com/mickisasi/drivefinder

go 1.21.0

require (
	github.com/Noooste/azuretls-client v1.2.3 // indirect
	github.com/Noooste/fhttp v1.0.6 // indirect
	github.com/Noooste/go-utils v1.0.4 // indirect
	github.com/Noooste/utls v1.2.2 // indirect
